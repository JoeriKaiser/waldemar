...
**Routing:** File-based — `src/pages/index.astro` (home), `src/pages/about.astro`, `src/pages/[slug].astro` (dynamic project detail pages from MDX). Uses Astro's ClientRouter for SPA-like view transitions.
